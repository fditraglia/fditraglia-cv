...
\begin{itemize}
  \item A Generalized Focused Information Criterion for GMM (with Minsu Chang), Provisionally Accepted: \emph{Journal of Applied Econometrics}.
...
\begin{description}[style=multiline,leftmargin=2cm,font=\normalfont]
  \item[2017--2018:] Rice, Syracuse, Cornell, SUNY Binghamton, Boston College, Georgetown, Econometric Society North Amerian Winter Meeting
