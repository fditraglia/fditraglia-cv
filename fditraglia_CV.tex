...
\begin{itemize}
  \item A Framework for Eliciting, Incorporating, and Disciplining Identification Beliefs in Linear Models (with Camilo Garcia-Jimeno, R\&R \emph{Journal of Econometrics})
  \item Mis-classified, Binary, Endogenous Regressors: Identification and Inference (with Camilo Garcia-Jimeno, R\&R \emph{Journal of Econometrics})
\end{itemize}
