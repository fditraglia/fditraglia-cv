...
\begin{itemize}
  ...
  \item A Bayesian Search for Asset Pricing Factors: a Sparse, Sequential Perspective (with Sid Chib)
\end{itemize}
...
\begin{tabular}{p{2cm}p{12cm}}
2015--2016: & Midwest Econometrics Group Meetings, Chicago Booth, Princeton, Penn State, International Society for Bayesian Analysis World Meeting\\ \\
