...
\begin{itemize}
  ...
  \item Selection of Invalid Instruments can Improve Estimation in Mendelian Randomization (with Ashish Patel, Verena Zuber, and Stephen Burgess)
\end{itemize}
...
\begin{itemize}
  ...
  \item Choosing additional Instruments for Mendelian Randomization under Pleiotropy (with Ashish Patel, Stephen Burgess, \& Verena Zuber) 
\end{itemize}

\section{\sc Grants}
\begin{itemize}
  \item John Fell OUP Research Fund Pump-priming Grant -- ``Identifying Causal Effects in Experiments with Social Interactions and Non-compliance,'' January 2020 -- December 2022 % 20,000 GBP
...
\section{\sc Teaching }
\vspace{0.5em}
Oxford: Treatment Effects (Grad), Limited Dependent Variables (Grad), Empirical Research Methods (Grad), Econometrics (Undergrad), Quantitative Economics (Undergrad), Behavioral \& Experimental Economics (Undergrad)
...
\begin{description}[style=multiline,leftmargin=2cm,font=\normalfont]
  \item[2021--2022] Cleveland FRB System Committee on Econometrics Conference, Exeter Institute of Data Science and Artificial Intelligence  
