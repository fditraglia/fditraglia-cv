...
\begin{itemize}
  ...
  \item Experimenting with Spillovers: A Guide for Practitioners (with Alejandro S\'anchez-Becerra), \emph{Invited Chapter, Oxford Handbook of Program Evaluation}
\end{itemize}
