...
\begin{itemize}
  \item Identifying the Effect of a Mis-classified, Binary, Endogenous Regressor (with Camilo Garcia-Jimeno), \emph{Journal of Econometrics}, Forthcoming.
...
\begin{description}[style=multiline,leftmargin=2cm,font=\normalfont]
  \item[2018--2019:] IAEE Annual Conference (Montreal), Philadelphia FRB, Oxford, SEA Annual Meetings, Aarhus, Duke 
