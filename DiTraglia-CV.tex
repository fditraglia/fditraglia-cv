...
\begin{itemize}
  \item Identifying Causal Effects in Experiments with Spillovers and Non-compliance (with Camilo Garcia-Jimeno, Rossa O'Keefe-O'Donovan, and Alejandro Sanchez), \emph{Re-submitted: Journal of Econometrics}
  \item Hidden Hazards and Screening Policy: Predicting Undetected Lead Exposure in Illinois (with Ali Abbasi, Ludovica Gazze, and Bridge Pals), \emph{Re-submitted: Journal of Health Economics}.
...
\begin{itemize}
  ...
  \item Oxford Public Policy Challenge Fund Award -- ``Mapping Disparities in Childhoold Lead Exposure in England,'' December 2021 -- May 2022 % 50,000 GBP
