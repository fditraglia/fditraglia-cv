...
\begin{itemize}
  \item Structured Payment in Pawnshop Borrowing: Mandates versus Choice (with Issac Meza, Joyce Sadka, Enrique Seira, \& Craig McIntosh), \emph{Conditionally Accepted, Review of Economic Studies}
...
\begin{itemize}
  ...
  \item Using Efficient Estimands and Human Genetics to Study Marginal Treatment Effects (with Ashish Patel \& Stephen Burgess), \emph{Revise and Re-submit, Annals of Applied Statistics}
